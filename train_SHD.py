...
p["HIDDEN_OUTPUT_MEAN"]= 1.2 # 0.06 0.0
p["HIDDEN_OUTPUT_STD"]= 0.6 # 0.03 0.3
p["W_REPORT_INTERVAL"] = 11000  # this should be at the end of the epoch (at first trial of evaluation)
p["TAU_MEM"] = 20.0 #20
p["TAU_MEM_OUTPUT"]= 1000.0
p["TAU_SYN"] = 5.0 #5
p["REG_TYPE"]= "simple"
p["LBD_UPPER"]= 1e-8 # 2e-9 # 2e-8 # 2e-14 (since removal of N_Batch), 5e-12 keep in mind that the term is applied to all contributing spikes ...
p["LBD_LOWER"]= 1e-8 #2e-8
p["NU_UPPER"]= 14
p["NU_LOWER"]= 5
