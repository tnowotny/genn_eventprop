...
with open("scan_SSC_JUWELS_16/JSSC16_scan_97.json","r") as f:
    p0= json.load(f)

for (name,value) in p0.items():
    p[name]= value

p["OUT_DIR"]= "scan_SSC_JUWELS_17/"
...
blend = [ [], [0.5, 0.5] ]
n_epoch = [ 200, 100 ]
n_train = [ 75466, 150932 ] # for non-blend, this number is meaningless, for blend I put explicitly 2x number of samples in SSC train
shift = [ 0, 40.0 ]
