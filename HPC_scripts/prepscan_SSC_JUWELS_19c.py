                        ...
                        for o in range(2):
                            if not (k == 1 and l == 1 and m == 1):
                                ...
                                with open(fname,"r") as f:
                                    p0= json.load(f)
                                for s in range(6):
                                    id0 = ((((((i*5+j)*2+k)*2+l)*2+m)*2+n)*2+o)*6+s
                                    print(id0)
                                    p = p0
                                    p["ORIG_NAME"] = fname
                                    ...
                                    p["OUT_DIR"] = "scan_SSC_JUWELS_19c"
                                    p["NAME"] = "JSSC19c_scan_"+str(id0)
