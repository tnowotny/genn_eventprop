...
\end{itemize}
  ...
  \begin{align}
    {\mathcal L}_{\text{max}} = - \frac{1}{N_{\text{batch}}} \sum_{i=1}^{N_{\text{batch}}} \log \frac{\exp\left(\max_{t \in [0, T]} V_{l(i)}(t)\right)}{\sum_{k=1}^{N_{\text{out}}}\exp\left(\max_{t \in [0, T]} V_{k}(t)\right)}
  \end{align}
  and
  \begin{align}
    {\mathcal L_{\text{sum}}} = - \frac{1}{N_{\text{batch}}} \sum_{i=1}^{N_{\text{batch}}} \log \frac{\exp\left(\int_0^T V_{l(i)}(t) dt\right)}{\sum_{k=1}^{N_{\text{out}}} \exp\left(\int_0^T V_{k}(t) dt\right)}.
  \end{align}
